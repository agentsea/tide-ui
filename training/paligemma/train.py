# -*- coding: utf-8 -*-
"""ft_paligemma_airbnb.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CmkmZ5EC5S0MNuB2-xfkObju7YJBqpE8
"""
...
def collate_fn(examples):
    ...
    texts = [f"{image_token}{bos_token}detect {example['element_name']}" for example in examples]
    # texts = ["detect " + example["element_name"] for example in examples]
    labels = [point2pg_output(example["bbox"], example["resolution"]) + f" {example['element_name']}" for example in examples]
